...
SOURCE = Path("/workspaces/Dev-BT/Result/06.05_A05_stopword")
...
TRACKS = [
    ...
    ("a05-8-repl", "A05-8｜repl 詞表迭代", "repl + tok + 段落 12-80", "以品牌／車款已替換為 Brand、Model 的語料為基礎，逐輪依 A06 representation 殘留詞增補。", [
        ("a05-8-repl-stopwords", "A05-8", "A05-8(repl)_tok(para12-80)/A05-8_stopword.md", "基礎詞表", "先區分核心建議與可選擇停用詞。"),
        ("a05-8-repl-1-stopwords", "A05-8.1", "A05-8(repl)_tok(para12-80)/A05-8.1_stopword.md", "第一次增補", "補入車機、影音、連線與產品展示殘留。"),
        ("a05-8-repl-2-stopwords", "A05-8.2", "A05-8(repl)_tok(para12-80)/A05-8.2_stopword.md", "第二次增補", "補入功能詞、車款 trim 與市場展示殘留。"),
        ("a05-8-repl-3-stopwords", "A05-8.3", "A05-8(repl)_tok(para12-80)/A05-8.3_stopword.md", "第三次增補", "處理代名詞、媒體語氣、UI 與一般車評語境。"),
    ]),
