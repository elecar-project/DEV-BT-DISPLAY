...
<div class="experiment-map-scroll" aria-label="DEV-BT 完整實驗地圖">
    <object class="experiment-map-full" type="image/svg+xml" data="{{ '/assets/img/experiment-map-full.svg?v=20260623-t03-map-v24' | relative_url }}">
    <img src="{{ '/assets/img/experiment-map-full.svg?v=20260623-t03-map-v24' | relative_url }}" alt="DEV-BT 完整實驗運行架構圖">
  </object>
</div>
...
| [T03 資料篩選驗證]({{ '/results/t03-overview.html' | relative_url }}) | 比較影長 1-35 分鐘與去頭尾各 5 家廠商的資料篩選結果 | 可檢視 |
| 其他 T04 節點 | 驗證與敏感度分析 | 待整理 |
