...
<tr><td>來源資料夾</td><td><code>#運行BERTopic整理/#4. UMAP（未整理）/A04-3(del)_tok(para12-80)</code></td></tr>
...
<div><span>主題數範圍</span><strong>26–39</strong></div>
<div><span>noise ratio 範圍</span><strong>17.84%–28.68%</strong></div>
<div><span>balance score 範圍</span><strong>0.775–0.867</strong></div>
</div>
...
<div class="table-scroll"><table class="semantic-table"><thead><tr><th>主題</th><th>代表詞（前 10）</th><th>代表句</th></tr></thead><tbody><tr><td>0</td><td>interior, seats, seat, space, leather, rear, materials, design, heated, inside, really, like</td><td>—</td></tr><tr><td>1</td><td>display, apple, android, carplay, inch, apple carplay, audio, touchscreen, navigation, music, screen, android auto</td><td>—</td></tr><tr><td>2</td><td>assist, safety, lane, parking, alert, collision, spot, traffic, blind, blind spot, driver, monitor</td><td>—</td></tr><tr><td>3</td><td>horsepower, engine, electric, torque, battery, motor, power, liter, cylinder, transmission, performance, electric motor</td><td>—</td></tr><tr><td>4</td><td>grille, rear, light, led, design, headlights, car, look, lines, lights, signature, new</td><td>—</td></tr><tr><td>5</td><td>charging, charge, stations, level, charger, fast, battery, dc, charging stations, volt, range, station</td><td>—</td></tr><tr><td>6</td><td>electric, ev, vehicles, new, electric car, electric vehicle, vehicle, electrified, car, electrification, cars, electric vehicles</td><td>—</td></tr><tr><td>7</td><td>thank, welcome, joining, today, good, live, questions, thanks, watching, hope, gentlemen, great</td><td>—</td></tr></tbody></table></div>
...
<div class="result-figure-scroller"><figure><img src="{{ '/assets/results/a04-3-del-tok-para12-80/charts/06_best_three_settings_comparison.png' | relative_url }}" alt="06 best three settings comparison"><figcaption>06 best three settings comparison</figcaption></figure></div>

<details class="result-chart-details">
<summary>完整參數圖表（5 張）</summary>
<p>用於追查各 UMAP／HDBSCAN 參數與主題數、離群比例、主題集中度之間的關係。</p>
<div class="result-figure-scroller"><figure><img src="{{ '/assets/results/a04-3-del-tok-para12-80/charts/01_min_cluster_size_vs_n_clusters_noise_ratio.png' | relative_url }}" alt="01 min cluster size vs n clusters noise ratio"><figcaption>01 min cluster size vs n clusters noise ratio</figcaption></figure><figure><img src="{{ '/assets/results/a04-3-del-tok-para12-80/charts/02_umap_n_neighbors_vs_largest_topic_ratio.png' | relative_url }}" alt="02 umap n neighbors vs largest topic ratio"><figcaption>02 umap n neighbors vs largest topic ratio</figcaption></figure><figure><img src="{{ '/assets/results/a04-3-del-tok-para12-80/charts/03_umap_n_components_vs_n_clusters.png' | relative_url }}" alt="03 umap n components vs n clusters"><figcaption>03 umap n components vs n clusters</figcaption></figure><figure><img src="{{ '/assets/results/a04-3-del-tok-para12-80/charts/04_hdbscan_min_samples_vs_noise_ratio.png' | relative_url }}" alt="04 hdbscan min samples vs noise ratio"><figcaption>04 hdbscan min samples vs noise ratio</figcaption></figure><figure><img src="{{ '/assets/results/a04-3-del-tok-para12-80/charts/05_cluster_selection_method_comparison.png' | relative_url }}" alt="05 cluster selection method comparison"><figcaption>05 cluster selection method comparison</figcaption></figure></div>
</details>
