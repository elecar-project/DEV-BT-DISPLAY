---
title: A05-6｜初步停用詞迭代
description: A05-6｜初步停用詞迭代 的停用詞版本線。
---

# A05-6｜初步停用詞迭代

從一般車輛與逐字稿雜訊出發，逐輪壓低非 EV 核心的產品展示、車機、賽道與銷售語境。

<aside class="table-note"><strong>資料版本：</strong><code>repl + tok + 段落 12-80</code>。每個節點均可查看停用詞分類、加入理由與原始檔。</aside>
