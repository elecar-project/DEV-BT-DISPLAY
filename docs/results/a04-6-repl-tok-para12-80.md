...
可下載：[comparison_summary.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/comparison_summary.csv' | relative_url }})、[embeddings_all-MiniLM-L6-v2.meta.json]({{ '/assets/results/a04-6-repl-tok-para12-80/embeddings_all-MiniLM-L6-v2.meta.json' | relative_url }})、[final_configs.json]({{ '/assets/results/a04-6-repl-tok-para12-80/final_configs.json' | relative_url }})、[representative_docs.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/representative_docs.csv' | relative_url }})、[Result_06.03_A04-6(repl)_tok(para12-80)-all_results.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/Result_06.03_A04-6(repl)_tok(para12-80)-all_results.csv' | relative_url }})、[Result_06.03_A04-6(repl)_tok(para12-80)-stage1_umap_hdbscan.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/Result_06.03_A04-6(repl)_tok(para12-80)-stage1_umap_hdbscan.csv' | relative_url }})、[Result_06.03_A04-6(repl)_tok(para12-80)-stage2_hdbscan_deep.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/Result_06.03_A04-6(repl)_tok(para12-80)-stage2_hdbscan_deep.csv' | relative_url }})、[Result_06.03_A04-6(repl)_tok(para12-80)-top10_stability.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/Result_06.03_A04-6(repl)_tok(para12-80)-top10_stability.csv' | relative_url }})、[Result_06.03_A04-6(repl)_tok(para12-80).md]({{ '/assets/results/a04-6-repl-tok-para12-80/Result_06.03_A04-6(repl)_tok(para12-80).md' | relative_url }})、[run_06.03_A04_6_repl_tok_para12_80.py]({{ '/assets/results/a04-6-repl-tok-para12-80/run_06.03_A04_6_repl_tok_para12_80.py' | relative_url }})、[run_log.json]({{ '/assets/results/a04-6-repl-tok-para12-80/run_log.json' | relative_url }})、[selected_configs.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/selected_configs.csv' | relative_url }})、[stage2_umap_candidates.json]({{ '/assets/results/a04-6-repl-tok-para12-80/stage2_umap_candidates.json' | relative_url }})、[topic_info.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/topic_info.csv' | relative_url }})、[topic_words.csv]({{ '/assets/results/a04-6-repl-tok-para12-80/topic_words.csv' | relative_url }})
</section>
</div>
