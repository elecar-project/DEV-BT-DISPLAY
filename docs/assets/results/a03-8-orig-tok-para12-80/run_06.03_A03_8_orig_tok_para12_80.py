...
OUTPUT_DIR = ROOT / "Result/06.03_A03_min-test/A03-8(orig)_tok(para12-80)"

REPORT_PATH = OUTPUT_DIR / "Result_06.03_A03-8(orig)_tok(para12-80).md"
MIN_TEST_CSV = OUTPUT_DIR / "Result_06.03_A03-8(orig)_tok(para12-80)-min_cluster_size.csv"
BEST_TOPIC_INFO_CSV = OUTPUT_DIR / "Result_06.03_A03-8(orig)_tok(para12-80)-best_topic_info.csv"
BEST_DOC_TOPICS_CSV = OUTPUT_DIR / "Result_06.03_A03-8(orig)_tok(para12-80)-best_document_topics.csv"
RUN_LOG_JSON = OUTPUT_DIR / "Result_06.03_A03-8(orig)_tok(para12-80)-run_log.json"
