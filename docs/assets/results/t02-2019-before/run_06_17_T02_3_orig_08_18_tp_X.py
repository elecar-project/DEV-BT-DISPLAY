...
RUN_BASENAME = "06.17_T02-3(orig_08-18_tp-X)"
OUTPUT_DIR = ROOT / "Result/06.17_T02_year" / RUN_BASENAME
DATASET_DIR = (
    ROOT
    / "Result/06.13_[B]tok/06.13_[B]03-pre_LLM(orig)_08-18(221)_tok(para12-80)_dataset"
)
STOPWORD_MD = (
    ROOT
...
m.CONFIG = {
    **m.CONFIG,
    ...
    "selection_reason": "User-specified T02 2008-2018 BERTopic run with c-TF-IDF topic reduction and fixed UMAP/HDBSCAN parameters.",
    "umap": {
        "n_neighbors": 10,
        "n_components": 5,
        "min_dist": 0.0,
