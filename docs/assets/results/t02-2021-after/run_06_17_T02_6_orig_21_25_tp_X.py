...
RUN_BASENAME = "06.17_T02-6(orig_21-25_tp-X)"
OUTPUT_DIR = ROOT / "Result/06.17_T02_year" / RUN_BASENAME
DATASET_DIR = (
    ROOT
    / "Result/06.13_[B]tok/06.13_[B]04-pre_LLM(orig)_21-25(146)_tok(para12-80)_dataset"
)
STOPWORD_MD = (
    ROOT
...
m.CONFIG = {
    **m.CONFIG,
    ...
    "selection_reason": "User-specified T02 2021-2025 BERTopic run with c-TF-IDF topic reduction.",
}
