# M02-1(orig-new-tp-30) BERTopic + A05-8.4(human) stopwords + c-TF-IDF reduction

## Run Info

| dataset | embedding_model | custom_stopword_count | llm_provider | llm_model | llm50_successful_calls | representative_docs_per_topic |
| --- | --- | --- | --- | --- | --- | --- |
| Result/06.03_A02/R06.03_A02-pre_LLM(orig)_tok(para12-80)_dataset | all-MiniLM-L6-v2 | 170 | OpenRouter | openai/gpt-5.5 | 1700 / 1700 | 6 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| auto | 10 | 15 | 0.0000 | 50 | 5 | eom | 0.2000 |

## Metrics

| n_clusters | noise_ratio | topic_-1_count | largest_topic_count | stable_topics | missing_llm_calls |
| --- | --- | --- | --- | --- | --- |
| 34 | 0.2477 | 2758 | 2459 | 20 / 34 | 0 |
...
| main_report | llm_report | llm_csv | llm_validation | detail | artifacts |
| --- | --- | --- | --- | --- | --- |
| M02-1(orig-new-tp-30).md | M02-1(orig-new-tp-30)_LLM.md | M02-1(orig-new-tp-30)_LLM.csv | M02-1(orig-new-tp-30)_LLM_validation.csv | M02-1(orig-new-tp-30)_LLM_detail.csv | artifacts/ |
