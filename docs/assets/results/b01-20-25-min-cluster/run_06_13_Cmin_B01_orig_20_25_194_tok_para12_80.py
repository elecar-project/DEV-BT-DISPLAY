...
OUTPUT_DIR = ROOT / "Result/06.13_[C]min/[B]01-(orig)_20-25(194)_tok(para12-80)"

RUN_LABEL = "06.13_[C]min_[B]01-(orig)_20-25(194)_tok(para12-80)"
FILE_STEM = "Result_06.13_[C]min_[B]01-(orig)_20-25(194)_tok(para12-80)"
...
CHART_PATH = OUTPUT_DIR / "[B]01-(orig)_20-25(194)_tok(para12-80)_min_cluster_chart.png"
...
def plot_elbow_chart(chart_title: str = "[B]01 orig 20-25(194) tok para12-80") -> None:
