...
OUTPUT_DIR = ROOT / "Result/06.03_A03_min-test/A03-2(del)_tok"

REPORT_PATH = OUTPUT_DIR / "Result_06.03_A03-2(del)_tok.md"
MIN_TEST_CSV = OUTPUT_DIR / "Result_06.03_A03-2(del)_tok-min_cluster_size.csv"
BEST_TOPIC_INFO_CSV = OUTPUT_DIR / "Result_06.03_A03-2(del)_tok-best_topic_info.csv"
BEST_DOC_TOPICS_CSV = OUTPUT_DIR / "Result_06.03_A03-2(del)_tok-best_document_topics.csv"
RUN_LOG_JSON = OUTPUT_DIR / "Result_06.03_A03-2(del)_tok-run_log.json"
