...
RUN_BASENAME = "06.17_T02-5(orig_08-20_tp-X)"
OUTPUT_DIR = ROOT / "Result/06.17_T02_year" / RUN_BASENAME
DATASET_DIR = (
    ROOT
    / "Result/06.13_[B]tok/06.13_[B]04-pre_LLM(orig)_08-20(288)_tok(para12-80)_dataset"
)
STOPWORD_MD = (
    ROOT
...
m.CONFIG = {
    **m.CONFIG,
    ...
    "selection_reason": "User-specified T02 2008-2020 BERTopic run with UMAP n_neighbors=10, n_components=5, min_dist=0.0; HDBSCAN min_cluster_size=125, min_samples=5, method=eom, epsilon=0.0; and c-TF-IDF topic reduction.",
    "umap": {
        **m.CONFIG["umap"],
        "n_neighbors": 10,
        "n_components": 5,
